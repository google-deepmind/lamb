...
name="$(default_name)_${lang}_${num_param_millions}m_${model}_fm_d${num_layers}_arms"
source_lib "run.sh" "$@"
...
tuneables="input_embedding_ratio,learning_rate,l2_penalty,
  input_dropout,inter_layer_dropout,state_dropout,
  output_dropout"
name="$(default_name)_${lang}_${num_param_millions}m_${model}_d${num_layers}_arms"
source_lib "run.sh" "$@"
